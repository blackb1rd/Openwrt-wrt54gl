 ...
 * spi_card_read_blk
 *
 * Send an sd card command that returns a single block of data
 *----------------------------------------------------------------------------*/
static unsigned char spi_card_read_blk(unsigned char cmd, unsigned int param, unsigned char crc7, unsigned char *buf, int len) {
    int i;
    unsigned char r = 0;
 ...
 *----------------------------------------------------------------------------*/
static INLINE unsigned char spi_card_write_multi_o(unsigned int addr, unsigned char *buf, int blocks, unsigned char first, unsigned char last) {
    volatile unsigned char *in = gpio_input;
    volatile unsigned char *out = gpio_output;
    const unsigned char clk_hi = spi_ps_d1_c1;
    const unsigned char clk_low = spi_ps_d1_c0;
 ...
 *----------------------------------------------------------------------------*/
static INLINE unsigned char spi_card_read_multi_o(unsigned int addr, unsigned char *buf, int blocks, unsigned char first, unsigned char last) {
    volatile unsigned char *in = gpio_input;
    volatile unsigned char *out = gpio_output;
    const unsigned char clk_hi = spi_ps_d1_c1;
    const unsigned char clk_low = spi_ps_d1_c0;
